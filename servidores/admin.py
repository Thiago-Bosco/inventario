...
class Servidores_CCAdmin(admin.ModelAdmin):
    list_display = ('id', 'server_name', 'server_cliente', 'datacenter', 'plataforma', 'ip', 'criticidade', 'responsabilidade', 'escalonamento1', 'escalonamento2', 'is_active')
    ...
    fields = ('server_name', 'server_cliente', 'ip', 'is_active', 'datacenter', 'plataforma', 'criticidade', 'responsabilidade', 'storage', 'os', 'ambiente', 'escalonamento1', 'escalonamento2', 'descricao')
